...
<html lang="pt">
  <head>
    ...
    <title>MathLearn | Radiciação</title>
  </head>
  ...
  <body>
    ...
    <?php include "../includes/overlayContAM.php"  ?>
      ...
      <div class="row">
        <main class="col-sm-8">
          <section id="sec01" class="container-fluid">
            <h1 class="txt-title01" >Radiciação</h1>
          </section>
          ...
          <div class="divisory d-flex justify-content-center">
            ...
            <section id="sec02" class="container-fluid">
              <div class="row d-flex justify-content-center ">
                <div class="col">
                  <p class="entrada"><span class="space"></span>Raiz quadrada disso, raiz cúbica daquilo...é, não podemos negar que, às vezes, a radiciação realmente confunte a gente.
                  Mas calma! Neste artigo você aprenderá e conhecerá mais sobre os processos de raiz quadrada, cúbica e muito mais! Vamos lá!😀 
                  </p>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col d-flex justify-content-center">
                  <img src="../../imgs/radiciacao-og.jpg" class="img-fluid img-top" alt="Imagem sobre radiciação">
                </div>
              </div>
              ...
              <div class="row d-flex justify-content-center ">
                <div class="col entrada">
                  ...
                  <br><span class="space"></span>A raiz quadrada é o tipo mais comum de radiciação, onde o índice é 2. Por exemplo, a raiz quadrada de 9 é representada por √9 e é igual a 3, porque 3 elevado ao quadrado é igual a 9.

                  <br><span class="space"></span>Existem também outras raízes, como a raiz cúbica, onde o índice é 3. Por exemplo, a raiz cúbica de 8 é representada por ∛8 e é igual a 2, porque 2 elevado ao cubo é igual a 8.

                  <br><span class="space"></span>A radiciação também pode envolver números irracionais, como a raiz quadrada de 2 (√2) ou a raiz cúbica de 5 (∛5). Esses números não podem ser expressos de forma exata como uma fração, resultando em valores decimais não terminantes e não periódicos.
                  <br>
                  <br><span class="space"></span>Algumas propriedades da radiciação incluem:

                  <br>
                  <ul>
                  <li>1. A raiz de um produto: √(a * b) = √a * √b;</li>
                  <li>2. A raiz de uma divisão: √(a / b) = √a / √b;</li>
                  <li>3. A raiz de uma potência: (√a)<sup>n</sup> = a<sup>(n/m)</sup>, onde n é o expoente da potência e m é o índice da raiz.</li>
                  </ul>

                  A radiciação é uma operação importante na matemática, sendo usada em diversos contextos, como cálculos numéricos, equações, geometria e outras áreas das ciências e engenharias.
                      </p>
                  </div>
                </div>
                </section>
            ...
            <section id="sec03" class="container-fluid">
              ...
              <div class="media d-flex justify-content-center">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/QmIjZgKhAEo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
              ...
              <div class="btn_yt d-flex justify-content-center">
                <a class="btn btn-primary" href="https://www.youtube.com/results?search_query=radicia%C3%A7%C3%A3o" target="_blank">Vamos para o YouTube!</a>
              </div>
            ...
            <section id="sec04" class="container-fluid">
              ...
              <div class="media d-flex justify-content-center">
                <iframe style="max-width:100%" src="https://wordwall.net/pt/embed/aebc59fe69d348ecba58b0bd5d02bd81?themeId=41&templateId=30&fontStackId=0" width="500" height="380" frameborder="0" allowfullscreen></iframe>
              </div>
      ...
      window.addEventListener('focus', function() {
        document.title = "MathLearn | Radiciação";
      });
