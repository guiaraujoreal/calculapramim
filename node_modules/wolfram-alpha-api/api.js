...
function createApiParams(baseUrl, input, output = 'string') {
  return new Promise((resolve, reject) => {
    switch (typeof input) {
      case 'string':
        resolve({ url: `${baseUrl}&i=${encodeURIComponent(input)}&podstate=Step-by-step%20solution`, output });
        break;
      case 'object':
        resolve({ url: `${baseUrl}&${querystring.stringify(input)}&podstate=Step-by-step%20solution`, output });
        break;
      default:
